...
import {AdmNotFoundRoutingModule} from './adm-not-found-routing.module';
...
@NgModule({
    declarations: [AdmNotFoundComponent, NotFoundPageComponent],
    imports: [
        CommonModule,
        AdmNotFoundRoutingModule,
...
export class AdmNotFoundModule {
}
